...
export default class BasicBattler implements Battler {
    ...
    protected _trueMaxHealth: number;
    ...
    public get relativePosition(): Vec2 {return this._targetable.relativePosition;}
    ...
    public get trueMaxHealth(): number {return this._trueMaxHealth;}
    public set trueMaxHealth(value: number) {this._trueMaxHealth = value;}
